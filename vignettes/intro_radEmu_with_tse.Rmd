...
```{r}
sum(colSums(SummarizedExperiment::assay(wirbel_china, "Count")) == 0) # no samples have a count sum of 0 
sum(rowSums(SummarizedExperiment::assay(wirbel_china, "Count")) == 0) # one category has a count sum of 0 
category_to_rm <- rowSums(SummarizedExperiment::assay(wirbel_china, "Count")) == 0
wirbel_china <- wirbel_china[!category_to_rm, ]
sum(rowSums(SummarizedExperiment::assay(wirbel_china, "Count")) == 0) # now no categories have a count sum of 0 
```
